...
static const char col_fg[]       	= "#282C34";
static const char col_bg[]       	= "#2C2E34";
static const char col_blue[]        = "#ABB2BF";
static const char col_fgi[]       	= "#FFFFFF";
static const char col_bgi[]         = "#61AFEF";
